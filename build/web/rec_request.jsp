    ...
    <body>
        ...
        <div class="container">
            <div class="alert alert-success alert-dismissible fade show" style="margin: 12px;">
                <strong>UPDATED record!</strong>successfully!!
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header" style="background-color: #343A40;">
                    <!-- [ Main Content ] start -->
                    <h5 style="color: white;font-weight: bold;">Receiver's Request</h5>
                </div>
                            ...
                            <table class="table table-hover m-b-0" id="myTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="color: red;"><%=rs.getString(7).toUpperCase()%></td>
                                        <td><a class="btn-sm" style="background-color: #6C757D;color: white;" href="org_rec_pending?email=<%=email%>&id=<%=rs.getString(1)%>">Done</a></td>
                                    </tr>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header" style="background-color: #343A40;">
                    <!-- [ Main Content ] start -->
                    <h5 style="color: white;font-weight: bold;">Receiver's Request(Without Registration)</h5>
                </div>
                <div class="card-body px-0 py-0">
                    <div class="table-responsive">
                        <div class="session-scroll" style="position:relative;height: 300px;">
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            try {
                                                ...
                                                pss = con.prepareStatement("SELECT without_reg.phone, without_reg.bldgrp, without_reg.status, without_reg.id FROM without_reg where without_reg.oid = '" + ccid + "' AND without_reg.status = 'pending'");
                                        ...
                                        <td style="color: red;"><%=rss.getString(3).toUpperCase()%></td>
                                        <td><a class="btn-sm" style="background-color: #6C757D;color: white;" href="org_rec_pending2?wid=<%=rss.getString(4)%>&email=<%=email%>">Done</a></td>
                                    </tr>
                                <%
                                        }
                                    } catch (Exception e) {
        ...
        <script>
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("rec_request.jsp?email=<%=email%>");
                }
