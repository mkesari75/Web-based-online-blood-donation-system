        ...
        <ul class="navbar-nav ms-auto" style="margin-right:70px;">
            <li class="nav-item dropdown " >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="rec_edit.jsp?email=<%=eemail%>">Edit Profile</a>
                    <a class="dropdown-item" href="rec_reset.jsp?email=<%=eemail%>">Reset Password</a>
                    <a class="dropdown-item" href="rec_logout">Log Out</a>
                </div>
            </li>   
        </ul>
    </div>
