<%-- 
    Document   : org_otppage
    Created on : Mar 7, 2021, 1:51:31 PM
    Author     : Mayur Kesari
--%>
    ...
    <head>
        ...
        <script>
            ...
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("org_otppage.jsp");
                }
    ...
    <body>
        ...
        <div class="form1">    
            <main class="form-signin">
                <form name="form1" class="text-center" method="post" action="org_otp" onsubmit="return validate()">
                    <div class="shadow p-3 mb-5 bg-white rounded" id="shadow">
                        ...
                        <a href="org_resendOtp"><input type="button" id="forgot_pass" value="Resend OTP" class="w-100 btn btn-lg btn-secondary"></a>
