    ...
    <head>
        ...
        <script>
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("a_dnr_details.jsp");
                }
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="page-header-title">
                                                    <h5 class="m-b-10">Donor Details</h5>
                                                </div>
                                                <ul class="breadcrumb">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header bg-secondary">
                                            <!-- [ Main Content ] start -->
                                            <h5 style="color: white;">Donor Details</h5>
                                        </div>
                                                            ...
                                                            <tr>
                                                                <%
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        ps = con.prepareStatement("SELECT dnr_signup.id, dnr_signup.fname, dnr_signup.mname, dnr_signup.lname ,dnr_signup.dob, dnr_signup.gender, dnr_signup.email, dnr_signup.address,state.state_name, city.city_name, dnr_signup.pincode, dnr_signup.phone, dnr_signup.bldgrp FROM dnr_signup INNER JOIN city ON dnr_signup.city_id=city.city_id INNER JOIN state ON dnr_signup.state_id=state.state_id order by timestamp desc");
                                                                ...
                                                                <td><a class="btn-sm btn-success" href="view_more.jsp?id=<%=rs.getString(1)%>">View More</a></td>
                                                            </tr>
                                                            <%
                                                                    }
                                                                } catch (Exception e) {
