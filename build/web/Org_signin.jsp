<%-- 
    Document   : Org_signin
    Created on : Dec 19, 2020, 9:17:06 PM
    Author     : Mayur Kesari
--%>
    ...
    <head>
        ...
        <script>
            ...
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("Org_signin.jsp");
                }
    ...
    <body style="margin-right: 12px;">
        ...
        <div class="form1">    
            <main class="form-signin">
                <form name="form1" class="text-center" method="get" action="org_login" onsubmit="return validate()">
                    <div class="shadow p-3 mb-5 bg-white rounded" id="shadow">
                        <img class="mb-4" src="images\signin.png" alt="" width="72" height="57">
                        <h1 class="h3 mb-3 fw-normal" style="color: #dc3545">ORGANIZATION SIGNIN</h1>
                        <hr>
                        ...
                        <div class="checkbox mb-3">
                            ...
                            <br>
                            <a href="org_signup.jsp"><input type="button" value="New User" class="w-100 btn btn-lg btn-light"></a>
                            <br>
                        </div>
                        <button class="w-100 btn btn-lg btn-danger" type="submit">Sign in</button>
                        <a href="org_forgot.jsp"><input type="button" id="forgot_pass" value="Forgot Password" class="w-100 btn btn-lg btn-secondary"></a>
