...
<html>
    <head>
        ...
        <title>Organization Forgot Password</title>
        ...
        <script>
            ...
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("org_forgot.jsp");
                }
    ...
    <body style="margin-right: 12px;">
        ...
        %>
            <div class="alert alert-success alert-dismissible fade show" style="margin-right: -12px; margin: 12px; margin-right: -1px; margin-bottom: -35px">
                <strong>Success!</strong> Password changed! <a href="Org_signin.jsp" class="alert-link">Click here to login.</a>.
