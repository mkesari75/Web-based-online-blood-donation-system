<%-- 
    Document   : dnr_edit
    Created on : Mar 8, 2021, 12:46:34 AM
    Author     : Mayur Kesari
--%>
                ...
                <div class="card-header">
                    <%
                        try {
                            ...
                            ps = con.prepareStatement("SELECT dnr_signup.id, dnr_signup.fname, dnr_signup.mname, dnr_signup.lname ,dnr_signup.dob, dnr_signup.gender, dnr_signup.email, dnr_signup.address,state.state_name, city.city_name, dnr_signup.pincode, dnr_signup.phone, dnr_signup.bldgrp FROM dnr_signup LEFT JOIN city ON dnr_signup.city_id=city.city_id LEFT JOIN state ON dnr_signup.state_id=state.state_id where email = '" + email + "'");
