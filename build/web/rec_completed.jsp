...
<html lang="en">
    ...
    <title>Receiver Completed</title>
    <!-- [ Header ] end -->
    <body>
        <%            
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="page-header-title">
                                                    <h5>Receiver Completed</h5>
                                                </div>
                                                <ul class="breadcrumb">
                                                    <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                                                    <li class="breadcrumb-item"><a href="#!">Receiver</a></li>
                                                    <li class="breadcrumb-item"><a href="#!">Completed</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header bg-secondary">
                                            <h5 style="color:white;">Completed Receivers</h5>
                                        </div>
                                                            ...
                                                            <tr>
                                                                <%                                                                    int id = 0;
                                                                    try {
                                                                        ...
                                                                        ps = con.prepareStatement("SELECT rec_signup.id, rec_signup.fname, rec_signup.mname, rec_signup.lname ,rec_signup.dob, rec_signup.gender, rec_signup.email, rec_signup.address,state.state_name, city.city_name, rec_signup.pincode, rec_signup.phone, rec_signup.bldgrp FROM rec_signup INNER JOIN city ON rec_signup.city_id=city.city_id INNER JOIN state ON rec_signup.state_id=state.state_id INNER JOIN request_blood ON rec_signup.id=request_blood.rid where request_blood.status='completed' order by request_blood.timestamp desc");
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="rec_delete?id=<%=rs.getString(1)%>"><input type="button" value="Yes" class="btn btn-primary"></a>
