<%-- 
    Document   : rec_otppage
    Created on : Mar 7, 2021, 12:51:14 PM
    Author     : Mayur Kesari
--%>
...
<html>
    <head>
        ...
        <script>
            ...
            function checkEvt() {
                ...
                if (evTypep == 'reload') {
                    window.location.replace("rec_otppage.jsp");
                }
    ...
    <body>
        <%
            ...
            try {
                if ("valid".equals(msg)) {
                    response.sendRedirect("Receiver_signup.jsp?msg=valid");
                }
        ...
        <div class="form1">    
            <main class="form-signin">
                <form name="form1" class="text-center" method="post" action="rec_otp" onsubmit="return validate()">
                    <div class="shadow p-3 mb-5 bg-white rounded" id="shadow">
                        ...
                        <a href="rec_resendOtp"><input type="button" id="forgot_pass" value="Resend OTP" class="w-100 btn btn-lg btn-secondary"></a>
